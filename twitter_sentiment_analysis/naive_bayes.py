...
# Y_test = [tweet[1]for tweet in test_tweets]
# print training_set
#
# algo = LinearDiscriminantAnalysis()
# algo.fit(training_set, Y_train)
# hypotheses = algo.predict (test_training_set)
#
# print "Misclassification rate is ", (1 -algo.score(test_training_set, Y_test))
